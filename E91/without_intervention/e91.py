...
def e91(alice_bits=None, bob_bits=None, vector=None):
  ...
  alice_key = discard_different_positions(measurements["alice"], same_bases_positions)
  bob_key = discard_different_positions(measurements["bob"], same_bases_positions)
